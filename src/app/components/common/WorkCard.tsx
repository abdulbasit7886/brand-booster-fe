...
const WorkCard = () => {
  return (
    <div className="flex items-center justify-center flex-wrap md:flex-nowrap md:gap-10 lg:gap-40 gap-6  px-10 md:my-10 lg:my-25">
        ...
        return (
          ...
          >
            ...
            <div className="gap-4">
              ...
              <p className="lg:text-[16px] md:text-xs text-sm text-textB lg:px-0 px-7  ">
                {item.subtext}
              </p>
            </div>
          </div>
