...
const ReadyGrow = () => {
  return (
    <div className="lg:w-[107rem] lg:h-[17rem] h-auto w-[98%] mt-7.5  py-12 lg:px-16 px-8 mx-auto bg-gradient-to-tr from-blue to-sky rounded-4xl flex items-center justify-between flex-col lg:flex-row ">
