  ...
  return (
    <div className="bg-white my-15 lg:my-30  lg:px-25 flex-col items-center justify-center w-screen">
      ...
      <button
        ...
        className="flex items-center lg:mt-0 mt-10 w-[92%] lg:w-auto justify-center py-2 lg:px-12 font-normal lg:py-5 gap-3 rounded-full mx-auto bg-gradient-to-tr from-sky to-blue text-white capitalize "
      >
